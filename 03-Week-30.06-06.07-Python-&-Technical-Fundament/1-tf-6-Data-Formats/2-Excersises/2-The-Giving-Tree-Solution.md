...
Cybersteps shows the submitted Python file json-python-convert.py as graded done. The submitted file is included here:

- [json-python-convert.py](json-python-convert.py)

![TF6 Ex2 Cybersteps submission](screenshots/tf6-ex2-the-giving-tree.png)
---
