...
The Cybersteps review shows the name greeting solution marked correct. The visible tests confirm that leading/trailing whitespace is removed, names are converted to title case, and the final greeting matches the required format.

![Name greeting Cybersteps result](screenshots/py10-ex1-name-greeting.png)
