...
The Challenges.txt file contains the documented keyboard shortcuts for Challenge A, B, and C.

[Evidence file](Challenges.txt)

The platform screenshot shows the assignment submitted and graded as Done.

![Platform evidence](screenshots/tf2-03-platform-submission.png)
